...
/***/ function(module, exports, __webpack_require__) {
	...
	var publisher = new _utils.Utils().makePublisher({
		...
		formLister: function formLister() {
			(0, _jquery2.default)(mapBox).on('click', '.item', function (e) {
				...
				if (target.tagName.toLowerCase() === 'input') {
					(function () {
						var type = (0, _jquery2.default)(_this).data('type'),
						    check = _this.checked;
		...
		// 绘制 根据中文地址 获取地点经纬度
		paint: function paint(data, type) {
			var _this2 = this;
			...
			data.forEach(function (v, i) {
				...
				var infoTemplate = '\n\t\t\t\t<div class=\'info\'>\n\t\t\t\t\t<h3>' + name + '</h3>\n\t\t\t\t\t<p>地点描述文字...<p>\n\t\t\t\t\t<p>' + address + '</p>\n\t\t\t\t\t<a href="' + link + '" target="_blank">查看详情</a>\n\t\t\t\t\t<a href="javascript:;" target="_blank">查看附近</a>\n\t\t\t\t\t<a href=\'javascript:;\' id=\'' + id + '\' data-name=\'' + name + '\' data-lng=\'' + lng + '\' data-lat=\'' + lat + '\' data-_address=\'' + _address + '\' class="route">添加到行程</a>\n\t\t\t\t</div>';
				_this2.makeMarks(latlng, type, infoTemplate, id);
				POINTS.push(latlng);
		...
		calculate: function calculate() {
			...
			(0, _jquery2.default)('#caculate-btn').click(function () {
				// 绘制导航路线
				_this3.calculateAndDisplayRoute();
			});
		},
		...
		calculateAndDisplayRoute: function calculateAndDisplayRoute() {
			...
			if (count >= 2) {
				var start = latlngSource[nodes.eq(0).data('id')];
				var end = latlngSource[nodes.eq(count - 1).data('id')];
		...
		sortable: function sortable() {
			...
			$sider.sortable({
				...
				update: function update(e, ui) {
					var $item = ui.item;
					_this5.calculateAndDisplayRoute();
					if (!$item.prev().length) {
