...
/***/ function(module, exports, __webpack_require__) {
	...
	var mapBox = document.getElementById('map-wrap'),
	    $mapBox = (0, _jquery2.default)(mapBox),
	    $sider = (0, _jquery2.default)('#sidebar'),
	    infoSource = {};
	...
	var publisher = new _utils.Utils().makePublisher({
		// 内容初始化
		content: function content() {
			//大阪
			var osaka = { lng: 135.3, lat: 34.4 };
			var form = (0, _jquery2.default)(_templates.formTemplate).get(0);
		...
		// 绑定表单事件
		formLister: function formLister() {
			(0, _jquery2.default)(mapBox).on('click', '.item', function (e) {
				var target = e.target;
				if (target.tagName.toLowerCase() === 'input') {
					var type = (0, _jquery2.default)(this).data('type'),
					    check = this.checked;
					if ((0, _jquery2.default)(target).prop('checked')) {
		...
		// 绘制 根据中文地址 获取地点经纬度
		paint: function paint(type) {
			var _this = this;

			var data = _data2.default[type],
			    lnglat = void 0;

			this.loading.show();

			var promises = data.map(function (v, i) {
				...
				promise.then(function (data) {
					...
					_this.makeMarks(data.lnglat, type, infoTemplate, id);
				});
		...
		makeMarks: function makeMarks(lnglat, type, content, id) {
		...
		// 清除标记
		removeMarks: function removeMarks(type) {
			CACHE[type].map(function (v, i) {
				v.setMap(null);
			});
			delete CACHE[type];
		},
		...
		loading: {
			show: function show() {
				if (!this.ins) {
					this.ins = (0, _jquery2.default)(_templates.loaderTemplate).appendTo('#map-wrap');
				}
			},
			hide: function hide() {
				this.ins.remove();
		...
		// 添加到行程 将地点添加到行程面板
		addToPanel: function addToPanel() {
			var self = this;
			$mapBox.on('click', '.route', function () {
				...
				var count = $sider.find('.lines').length;
				var id = $this.attr('id');
				var html = count >= 1 ? '<section class=\'lines\' data-id=' + id + ' data-lat=' + lat + ' data-lng=' + lng + '>\n\t\t\t\t\t\t\t<div class="distance">距离:待测 自驾时长:待测</div>\n\t\t\t\t\t\t\t<div class="spot">\n\t\t\t\t\t\t\t\t<a href="javascript:;" class="delete">删除</a>\n\t\t\t\t\t\t\t\t<h4>' + name + '</h4>\n\t\t\t\t\t\t\t</div>\n\t\t\t\t\t\t</section>' : '<section class=\'lines\' data-id=' + id + ' data-lat=' + lat + ' data-lng=' + lng + '>\n\t\t\t\t\t\t\t<div class="spot">\n\t\t\t\t\t\t\t\t<a href="javascript:;" class="delete">删除</a>\n\t\t\t\t\t\t\t\t<h4>' + name + '</h4>\n\t\t\t\t\t\t\t</div>\n\t\t\t\t\t\t</section>';
		...
		calculate: function calculate() {
			...
			(0, _jquery2.default)('#caculate-btn').click(function () {
				// 绘制导航路线
		...
		// 导向
		calculateAndDisplayRoute: function calculateAndDisplayRoute() {
			var _this3 = this;

			var nodes = $sider.find('.lines');
			...
			if (count >= 2) {
				...
				var points = nodes.slice(1, -1);

				_jquery2.default.each(points, function (i, v) {
					waypts.push({
						// 指定路径点的地址
						location: {
				...
				directionsService.route({
					...
					if (status === google.maps.DirectionsStatus.OK) {
						(function () {
							...
							var $distance = $sider.find('.distance');
							legs.map(function (v, i) {
								var time = v['duration'].text,
		...
		// 绘制 折线
		drawPath: function drawPath(response) {
			var legs = response.routes[0].legs;
			var coordinates = function () {
				var ret = [];
				legs.forEach(function (v, i) {
					v['steps'].forEach(function (value, index) {
		...
		// 侧栏管理
		sideBarMannger: function sideBarMannger() {
			var self = this;
			$sider.on('click', '.delete', function () {
				var $section = (0, _jquery2.default)(this).closest('.lines'),
				    id = $section.data('id');
				var $next = $section.next('.lines'),
			...
			.on('click', '.lines', function () {
				if (!(0, _jquery2.default)(this).hasClass('now')) {
					(0, _jquery2.default)(this).addClass('now').siblings().removeClass('now');
				} else {
					(0, _jquery2.default)(this).removeClass('now');
				}
			});
		},
		...
		sortable: function sortable() {
			...
			$sider.sortable({
				...
				update: function update(e, ui) {
					var $item = ui.item;
					_this4.calculateAndDisplayRoute();
					if (!$item.prev().length) {
		...
		makeIcon: function makeIcon(type) {
			var iconPath = location.protocol + '//' + location.hostname + '/gmap/public/images/';
			var cfg = {
				'michelin': {
...
/***/ function(module, exports) {
	...
	var Utils = function () {
		...
		_createClass(Utils, [{
			key: 'makePublisher',
			value: function makePublisher(child, params) {
				var i = 0,
				    l;
			...
			key: 'merge',
			value: function merge(child, parent) {
				var p;
				child = child || {};
				for (p in parent) {
...
/***/ function(module, exports) {
	...
	exports.default = {
		hotel: [{
			name: '大阪万豪酒店',
			address: '日本 大阪府 545-0052',
			link: 'https://www.booking.com/hotel/jp/osaka-marriott-miyako.zh-cn.html?aid=304142;label=gen173nr-1FCAEoggJCAlhYSDNiBW5vcmVmaDGIAQGYATK4AQfIAQzYAQHoAQH4AQuoAgM;sid=2ea53e4da33f7abe6f2cc7b7e5654641;dcid=1;ucfs=1;room1=A,A;dest_type=city;dest_id=-240905;srfid=69f8c178d5796084fe0ada87d33c4acf1c31aa39X1;highlight_room='
		}, {
			name: '新大阪站万怡酒店',
			address: '532-0003 大阪府, 大阪, Yodogawa-ku Miyahara 1-2-70, 日本',
			link: 'https://www.booking.com/hotel/jp/laforet-shinosaka.zh-cn.html?aid=304142;label=gen173nr-1FCAEoggJCAlhYSDNiBW5vcmVmaDGIAQGYATK4AQfIAQzYAQHoAQH4AQuoAgM;sid=2ea53e4da33f7abe6f2cc7b7e5654641;dcid=1;ucfs=1;room1=A,A;dest_type=city;dest_id=-240905;srfid=69f8c178d5796084fe0ada87d33c4acf1c31aa39X2;highlight_room='
		}, {
			name: '大阪瑞士南海酒店',
			address: '542-0076 大阪府, 大阪, Chuo-ku Namba 5-1-60, 日本',
			link: 'https://www.booking.com/hotel/jp/swissotel-nankai-osaka-osaka.zh-cn.html?aid=304142;label=gen173nr-1FCAEoggJCAlhYSDNiBW5vcmVmaDGIAQGYATK4AQfIAQzYAQHoAQH4AQuoAgM;sid=2ea53e4da33f7abe6f2cc7b7e5654641;dcid=1;ucfs=1;room1=A,A;dest_type=city;dest_id=-240905;srfid=69f8c178d5796084fe0ada87d33c4acf1c31aa39X3;highlight_room='
		}],
		spot: [],
		restaurant: [],
		michelin: [{
			name: '太庵',
			address: '中央区 島之内 1-21-2 山本松ビル１Ｆ',
			link: 'http://m.yqqjp.com/weixin/product-detail.html?cid=14'
		}, {
			name: '弧柳',
			address: '北区堂岛1-5-1 エスパス北新地２３　１Ｆ',
			link: 'http://m.yqqjp.com/weixin/product-detail.html?cid=16'
		}, {
			name: '多古安',
			address: '大阪府大阪市港区夕凪 1-15-5',
			link: 'http://m.yqqjp.com/weixin/product-detail.html?cid=42'
		}]
	};
...
/***/ function(module, exports, __webpack_require__) {
	...
	// module
	exports.push([module.id, "/**\n * Reset Css\n */\nhtml,body,div,p,a,h1,h2,h3,h4,span,strong,form,input,button,fieldset,ul,li,ol { padding: 0; margin: 0; box-sizing:border-box;  }  \nbody,html { width: 100%; height: 100%; color: #000; overflow: hidden; background-color: #eee; }\n\na,a:hover,a:visited { color: #000; text-decoration: underline;  }\n.abs { position: absolute; }\n.rel { position: relative; }\n.fix { position: fixed; }\n\n.i-b { display: inline-block; }\n.none { display: none; }\n.block { display: block; }\n\n.fl { float: left; }\n.fr { float: right; }\n\n.t-c { text-align: center; }\n.t-l { text-align: left; }\n.t-r { text-align: right; }\n\n.disable { color: #333; text-decoration: none;  }\n.disable:hover { text-decoration: none; cursor: pointer; }\n\n.hidden { overflow: hidden; }\n\n.map-wrap { height: 100%; margin-right: 255px; }\n\n.sidebar-box { float: right; width: 250px; height: 100%; padding: 0 0 10px; overflow: auto; }\n.sidebar-box h3 { margin-left: 10px; padding: 10px 0; }\n.sidebar-box h3 a { margin-right: 10px;  }\n.sidebar-box .lines { background-color: #fff; box-shadow: 1px 1px 1px rgba(0, 0, 0, .3); margin-bottom: 10px; }\n.sidebar-box .lines.now { background-color: rgba(250, 158, 37, 0.15); }\n.sidebar-box .lines.now .distance { background-image: none; color: #ccc; }\n.sidebar-box .distance { display: block; background:url(http://common3.qyerstatic.com/plan/mobile/home/img/v2/v2_2.png) 0 0 repeat; color: #666; }\n.sidebar-box .distance,\n.sidebar-box .spot { padding: 8px 10px; }\n.sidebar-box .spot a { float: right; margin-right: 10px;  }\n\n.panel { margin: 10px; width: auto; background:none; box-shadow: rgba(0, 0, 0, 0.298039) 0px 1px 4px -1px; background-color: rgb(255, 255, 255); background-clip: padding-box; border-radius: 2px; }\n.panel span { margin:0 2px; }\n.panel label { padding: 8px; -webkit-background-clip: padding-box;  min-width: 24px; font-weight: 500;   }\n.panel label:hover { background-color: rgb(235, 235, 235); }\n\n.state-highlight { background-color: rgba(220, 20, 20, .1); height: 40px; }\n\n.ui-btn,.ui-btn-lg,.ui-btn-s {\n    height: 30px;\n    line-height: 30px;\n    padding: 0 11px;\n    min-width: 55px;\n    display: inline-block;\n    position: relative;\n    text-align: center;\n    font-size: 15px;\n    background-color: #fdfdfd;\n    background-image: -webkit-gradient(linear,left top,left bottom,color-stop(0.5,#fff),to(#fafafa));\n    vertical-align: top;\n    color: #00a5e0;\n    -webkit-box-sizing: border-box;\n    -webkit-background-clip: padding-box;\n    background-clip: padding-box;\n    border: 1px solid #cacccd;\n    border-radius: 3px;\n    outline: none;\n    cursor: pointer;\n}\n\n.ui-btn-danger {\n    background-color:rgb(220, 20, 20);\n    background-image: -webkit-gradient(linear,left top,left bottom,color-stop(0.5,rgb(220, 20, 20)),to(rgb(220, 20, 20)));\n    color: #fff;\n    border-color: #f43d30;\n    -webkit-background-clip: padding-box;\n    background-clip: padding-box\n}\n\n.info a { margin-right:2px;  }\n\n.spinner {\n\tleft: 50%;\n\ttop: 50%;\n    width: 50px;\n    height: 50px;\n    margin-top: -25px;\n    margin-left: -25px;\n    position: absolute;\n}\n\n.container1 > div,\n.container2 > div,\n.container3 > div {\n    width: 15px;\n    height: 15px;\n    background-color: rgb(220, 20, 20);\n    border-radius: 100%;\n    position: absolute;\n    -webkit-animation: bouncedelay 1.2s infinite ease-in-out;\n    animation: bouncedelay 1.2s infinite ease-in-out;\n    -webkit-animation-fill-mode: both;\n    animation-fill-mode: both;\n}\n\n.spinner .spinner-container {\n    position: absolute;\n    width: 100%;\n    height: 100%;\n}\n\n.container2 {\n    -webkit-transform: rotateZ(45deg);\n    transform: rotateZ(45deg);\n}\n\n.container3 {\n    -webkit-transform: rotateZ(90deg);\n    transform: rotateZ(90deg);\n}\n\n.circle1 {\n    top: 0;\n    left: 0;\n}\n\n.circle2 {\n    top: 0;\n    right: 0;\n}\n\n.circle3 {\n    right: 0;\n    bottom: 0;\n}\n\n.circle4 {\n    left: 0;\n    bottom: 0;\n}\n\n.container2 .circle1 {\n    -webkit-animation-delay: -1.1s;\n    animation-delay: -1.1s;\n}\n\n.container3 .circle1 {\n    -webkit-animation-delay: -1.0s;\n    animation-delay: -1.0s;\n}\n\n.container1 .circle2 {\n    -webkit-animation-delay: -0.9s;\n    animation-delay: -0.9s;\n}\n\n.container2 .circle2 {\n    -webkit-animation-delay: -0.8s;\n    animation-delay: -0.8s;\n}\n\n.container3 .circle2 {\n    -webkit-animation-delay: -0.7s;\n    animation-delay: -0.7s;\n}\n\n.container1 .circle3 {\n    -webkit-animation-delay: -0.6s;\n    animation-delay: -0.6s;\n}\n\n.container2 .circle3 {\n    -webkit-animation-delay: -0.5s;\n    animation-delay: -0.5s;\n}\n\n.container3 .circle3 {\n    -webkit-animation-delay: -0.4s;\n    animation-delay: -0.4s;\n}\n\n.container1 .circle4 {\n    -webkit-animation-delay: -0.3s;\n    animation-delay: -0.3s;\n}\n\n.container2 .circle4 {\n    -webkit-animation-delay: -0.2s;\n    animation-delay: -0.2s;\n}\n\n.container3 .circle4 {\n    -webkit-animation-delay: -0.1s;\n    animation-delay: -0.1s;\n}\n\n@-webkit-keyframes bouncedelay {\n    0%,\n    80%,\n    100% {\n        -webkit-transform: scale(0.0);\n    }\n    40% {\n        -webkit-transform: scale(1.0);\n    }\n}\n\n@keyframes bouncedelay {\n    0%,\n    80%,\n    100% {\n        -webkit-transform: scale(0.0);\n        transform: scale(0.0);\n    }\n    40% {\n        -webkit-transform: scale(1.0);\n        transform: scale(1.0);\n    }\n}\n\n\n", ""]);
